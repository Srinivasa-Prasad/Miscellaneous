...
## Download-WebInstallerFile -FileTitle 'Visual Studio Code - PowerShell Extension (Blob)' -DestinationFile 'C:\ms-vscode.PowerShell.vsix' -SourceFile 'https://srinivasablobstorage.file.core.windows.net/downloads/ms-vscode.PowerShell-1.10.1.vsix?st=2018-12-12T05%3A10%3A26Z&se=2021-12-31T05%3A10%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=UE5%2FgIjdlPSTZZxv3iRu4xTBLLJNaNTEegsbP%2FosC4E%3D'
## Download-WebInstallerFile -FileTitle 'Visual Studio Code - Azure Repos Extension (Blob)' -DestinationFile 'C:\ms-vsts.team.vsix' -SourceFile 'https://srinivasablobstorage.file.core.windows.net/downloads/ms-vsts.team-1.144.1.vsix?st=2018-12-12T05%3A10%3A46Z&se=2021-12-31T05%3A10%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=BF2NAcKD9EY5%2BZ2xSkh%2BYSmUnQM6gm%2FWG1jJy4JR%2F8w%3D'
## Download-WebInstallerFile -FileTitle 'Visual Studio Code - Azure Resource Manager Tools Extension (Blob)' -DestinationFile 'C:\msazurermtools.azurerm-vscode-tools.vsix' -SourceFile 'https://srinivasablobstorage.file.core.windows.net/downloads/msazurermtools.azurerm-vscode-tools-0.4.2.vsix?st=2018-12-12T05%3A11%3A11Z&se=2021-12-31T05%3A11%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=Q5n%2BFB0SkN9ruc41RRaVQwAbOL0HXPPJf9mtbzmkSKQ%3D'
## Download-WebInstallerFile -FileTitle 'Visual Studio Code - Docker Extension (Blob)' -DestinationFile 'C:\vscode-docker.vsix' -SourceFile 'https://srinivasablobstorage.file.core.windows.net/downloads/PeterJausovec.vscode-docker-0.4.0.vsix?st=2018-12-12T05%3A11%3A35Z&se=2021-12-31T05%3A11%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=YRilmGsTHtDI7IhXPff41Fr%2FSNHO1gvdfxQfXeFJpxI%3D'
...
Execute-InstallationCommand -CommandTitle 'Visual Studio Code' -CommandPath 'C:\Program Files\Microsoft VS Code\Code.exe' -CommandArguments '--install-extension ms-vsts.team'
Execute-InstallationCommand -CommandTitle 'Visual Studio Code' -CommandPath 'C:\Program Files\Microsoft VS Code\Code.exe' -CommandArguments '--install-extension msazurermtools.azurerm-vscode-tools'
Execute-InstallationCommand -CommandTitle 'Visual Studio Code' -CommandPath 'C:\Program Files\Microsoft VS Code\Code.exe' -CommandArguments '--install-extension peterjausovec.vscode-docker'
