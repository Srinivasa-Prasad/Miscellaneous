...
Download-WebInstallerFile -FileTitle 'Azure Data Studio (Blob)' -DestinationFile 'C:\AzureDataStudio.exe' -SourceFile 'https://srinivasablobstorage.file.core.windows.net/downloads/azuredatastudio-windows-setup-1.2.4.exe?st=2018-12-14T08%3A34%3A46Z&se=2020-12-31T08%3A34%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=hOKydqQvwEf5iSbWV4L1n7OrumvLezR5BAnua8rlij8%3D'
Download-WebInstallerFile -FileTitle 'Azure Storage Explorer (Blob)' -DestinationFile 'C:\AzureStorageExplorer.exe' -SourceFile 'https://srinivasablobstorage.file.core.windows.net/downloads/StorageExplorer.exe?st=2018-12-14T08%3A35%3A11Z&se=2020-12-31T08%3A35%3A00Z&sp=rl&sv=2018-03-28&sr=f&sig=4IDNe7n1V6L8dW6%2BvZuTTTsIaJOCWMSjHSCYL36w%2FcY%3D'
