...
New-AzureRmResourceGroupDeployment -Name ARMVMDeploy -ResourceGroupName PRASASRI -TemplateFile https://raw.githubusercontent.com/Srinivasa-Prasad/Miscellaneous/master/DeployCloud.json